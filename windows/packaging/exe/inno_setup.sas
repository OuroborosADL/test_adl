...
[UninstallDelete]
Type: filesandordirs; Name: "{userappdata}\ADL"
...
var
  ResultCode: Integer;
begin
  Exec('taskkill', '/F /IM adl.exe', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Exec('net', 'stop "ADLTunnelService"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Exec('sc.exe', 'delete "ADLTunnelService"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Result := True;
end;