                      ...
                      _In_ wchar_t *command_line, _In_ int show_command)
{
  ...
  if (SendAppLinkToInstance(L"ADL"))
  {
    return EXIT_SUCCESS;
  }

  HANDLE hMutexInstance = CreateMutex(NULL, TRUE, L"ADLMutex");
  HWND handle = FindWindowA(NULL, "ADL");
  ...
  if (GetLastError() == ERROR_ALREADY_EXISTS)
  {
    ...
    if (window.SendAppLinkToInstance(L"ADL"))
    {
      return false;
    }
  ...
  if (!window.Create(L"ADL", origin, size))
  {
    return EXIT_FAILURE;
  }
