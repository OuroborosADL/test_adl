...
@$core.Deprecated('Use adlOptionsDescriptor instead')
const ADLOptions$json = const {
  '1': 'ADLOptions',
  '2': const [
    ...
    const {'1': 'rules', '3': 10, '4': 3, '5': 11, '6': '.adloptions.Rule', '10': 'rules'},
    const {'1': 'warp', '3': 11, '4': 1, '5': 11, '6': '.adloptions.WarpOptions', '10': 'warp'},
    const {'1': 'warp2', '3': 12, '4': 1, '5': 11, '6': '.adloptions.WarpOptions', '10': 'warp2'},
    const {'1': 'mux', '3': 13, '4': 1, '5': 11, '6': '.adloptions.MuxOptions', '10': 'mux'},
    const {'1': 'tls_tricks', '3': 14, '4': 1, '5': 11, '6': '.adloptions.TLSTricks', '10': 'tlsTricks'},
    const {'1': 'dns_options', '3': 15, '4': 1, '5': 11, '6': '.adloptions.DNSOptions', '10': 'dnsOptions'},
    const {'1': 'inbound_options', '3': 16, '4': 1, '5': 11, '6': '.adloptions.InboundOptions', '10': 'inboundOptions'},
    const {'1': 'url_test_options', '3': 17, '4': 1, '5': 11, '6': '.adloptions.URLTestOptions', '10': 'urlTestOptions'},
    const {'1': 'route_options', '3': 18, '4': 1, '5': 11, '6': '.adloptions.RouteOptions', '10': 'routeOptions'},
  ],
};

/// Descriptor for `ADLOptions`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adlOptionsDescriptor = $convert.base64Decode('');
...
const DNSOptions$json = const {
  ...
  '2': const [
    ...
    const {'1': 'remote_dns_domain_strategy', '3': 2, '4': 1, '5': 14, '6': '.adloptions.DomainStrategy', '10': 'remoteDnsDomainStrategy'},
    const {'1': 'direct_dns_address', '3': 3, '4': 1, '5': 9, '10': 'directDnsAddress'},
    const {'1': 'direct_dns_domain_strategy', '3': 4, '4': 1, '5': 14, '6': '.adloptions.DomainStrategy', '10': 'directDnsDomainStrategy'},
...
const RouteOptions$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ipv6_mode', '3': 2, '4': 1, '5': 14, '6': '.adloptions.DomainStrategy', '10': 'ipv6Mode'},
...
const TLSTricks$json = const {
  ...
  '2': const [
    ...
    const {'1': 'fragment_size', '3': 2, '4': 1, '5': 11, '6': '.adloptions.IntRange', '10': 'fragmentSize'},
    const {'1': 'fragment_sleep', '3': 3, '4': 1, '5': 11, '6': '.adloptions.IntRange', '10': 'fragmentSleep'},
    const {'1': 'mixed_sni_case', '3': 4, '4': 1, '5': 8, '10': 'mixedSniCase'},
    const {'1': 'enable_padding', '3': 5, '4': 1, '5': 8, '10': 'enablePadding'},
    const {'1': 'padding_size', '3': 6, '4': 1, '5': 11, '6': '.adloptions.IntRange', '10': 'paddingSize'},
  ],
};
...
const WarpOptions$json = const {
  ...
  '2': const [
    ...
    const {'1': 'wireguard_config', '3': 5, '4': 1, '5': 11, '6': '.adloptions.WarpWireguardConfig', '10': 'wireguardConfig'},
    const {'1': 'fake_packets', '3': 6, '4': 1, '5': 9, '10': 'fakePackets'},
    const {'1': 'fake_packet_size', '3': 7, '4': 1, '5': 11, '6': '.adloptions.IntRange', '10': 'fakePacketSize'},
    const {'1': 'fake_packet_delay', '3': 8, '4': 1, '5': 11, '6': '.adloptions.IntRange', '10': 'fakePacketDelay'},
    ...
    const {'1': 'account', '3': 12, '4': 1, '5': 11, '6': '.adloptions.WarpAccount', '10': 'account'},
  ],
};
