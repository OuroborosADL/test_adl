...
import 'package:adl/core/utils/laststeam.dart';
...
final _logger = Loggy('FFIADLCoreService');

class CoreInterfaceMobile extends CoreInterface with InfraLogger {
  static const channelPrefix = "com.adl.app";
  ...
  Future<String> setup(Directories directories, bool debug, int mode) async {
    ...
    // await start("/sdcard/Android/data/app.adl.com/files/configs/cdc633e9-8cfc-4a67-948d-009f779a5c91.json", "adl");
    return "";
  }
