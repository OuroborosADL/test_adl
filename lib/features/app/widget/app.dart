...
import 'package:adl/core/theme/app_theme.dart';
import 'package:adl/core/theme/theme_preferences.dart';
import 'package:adl/features/app_update/notifier/app_update_notifier.dart';
import 'package:adl/features/connection/widget/connection_wrapper.dart';
import 'package:adl/features/per_app_proxy/overview/per_app_proxy_service_notifier.dart';
import 'package:adl/features/profile/notifier/profiles_update_notifier.dart';
import 'package:adl/features/shortcut/shortcut_wrapper.dart';
import 'package:adl/features/system_tray/notifier/system_tray_notifier.dart';
import 'package:adl/features/window/widget/window_wrapper.dart';
...
class App extends HookConsumerWidget with WidgetsBindingObserver, PresLogger {
  ...
  void onPause(WidgetRef ref) {
    ...
    ref.read(adlCoreServiceProvider).closeFront();
  }

  void onResume(WidgetRef ref) {
    // if (PlatformUtils.isDesktop) return;
    ref.read(adlCoreServiceProvider).init();
