...
import 'package:adl/core/model/region.dart';
...
import 'package:adl/features/per_app_proxy/data/auto_selection_repository.dart';
import 'package:adl/features/per_app_proxy/data/auto_selection_repository_provider.dart';
import 'package:adl/features/per_app_proxy/data/selected_data_provider.dart';
import 'package:adl/features/per_app_proxy/model/per_app_proxy_backup.dart';
import 'package:adl/features/per_app_proxy/model/per_app_proxy_mode.dart';
import 'package:adl/features/per_app_proxy/model/pkg_flag.dart';
...
class PerAppProxy extends _$PerAppProxy with AppLogger {
  ...
  Future<bool> shareOnGithub() async {
    ...
    if (userSelected.isNotEmpty || forceDeselected.isNotEmpty) {
      ...
      body = '```\n$body\n```';
      UriUtils.tryLaunch(Uri.parse('https://github.com/adl/Android-GFW-Apps/issues/new?title=$title&body=$body'));
      return true;
    } else {
      ref
          .read(inAppNotificationControllerProvider)
