...
import 'package:adl/core/analytics/analytics_controller.dart';
import 'package:adl/core/app_info/app_info_provider.dart';
import 'package:adl/core/directories/directories_provider.dart';
import 'package:adl/core/localization/translations.dart';
import 'package:adl/core/logger/logger.dart';
import 'package:adl/core/logger/logger_controller.dart';
import 'package:adl/core/model/environment.dart';
import 'package:adl/core/preferences/general_preferences.dart';
import 'package:adl/core/preferences/preferences_migration.dart';
import 'package:adl/core/preferences/preferences_provider.dart';
import 'package:adl/features/app/widget/app.dart';
import 'package:adl/features/auto_start/notifier/auto_start_notifier.dart';

import 'package:adl/features/log/data/log_data_providers.dart';
...
import 'package:adl/features/window/notifier/window_notifier.dart';
import 'package:adl/adlcore/adl_core_service_provider.dart';
import 'package:adl/riverpod_observer.dart';
...
Future<void> lazyBootstrap(WidgetsBinding widgetsBinding, Environment env) async {
  ...
  await _init("adl-core", () => container.read(adlCoreServiceProvider).init());
